            ...
            style={{
                ...
                <View
                         ...
                         <View style={{
                          ...
                          <View style={{ width:30 , height :30 ,flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                            ...
                            <TouchableOpacity onPress={()=> this.onPress("a")} style={{ flex:1 , height :30 ,flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                                <Text style={{alignItems:"center",color:'#ffff' , fontSize:12, textAlign: 'right',fontFamily:"IRANSansWeb"}}>پربازدید ترین ها</Text>
                            ...
                            <TouchableOpacity onPress={()=> this.onPress("b")} style={{ flex:1 , height :30 ,flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                                <Text style={{alignItems:"center",color:'#ffff' , fontSize:12, textAlign: 'right',fontFamily:"IRANSansWeb"}}>برترین ها</Text>
                            ...
                            <TouchableOpacity onPress={()=> this.onPress("c")} style={{ flex:1 , height :30 ,flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                                <Text style={{alignItems:"center",color:'#ffff' , fontSize:12, textAlign: 'right',fontFamily:"IRANSansWeb"}}>تازه ترین ها</Text>
                    ...
                    <ViewPager
                        ...
                        initialPage={2}>
                  <View key="0">
                    <View><BlogView id="MostViewed"/></View>
                  </View>
                  <View key="1">
                  <View ><BlogView id="Top" /></View>
                  </View>
                  <View key="2">
                  <View ><BlogView id="Newest"/></View>
                  </View>
